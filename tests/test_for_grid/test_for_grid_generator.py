...
def test_for_grid_generator_log_scale(create_grid_generator: GridGenerator) -> None:
    info = create_grid_generator.grid_generator()
...
def test_for_grid_generator_lin_scale(create_lin_grid_generator: GridGenerator) -> None:
    info = create_lin_grid_generator.grid_generator()
...
def test_for_grid_generator_emergency_lin_scale(create_emergency_grid_generator: GridGenerator) -> None:
    info = create_emergency_grid_generator.grid_generator()
