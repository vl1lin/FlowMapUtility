...
from Run_Core.worker_settings import worker_function, init_worker
...
def test_core_run(core_beginer: "ProcessManager") -> None:
    ...
    tasks = [(0, [0.1, 0.2, 0.3], [3. for _ in range(3)]),
        (1, [0.1, 0.2, 0.3], [2. for _ in range(3)]),
        (2, [0.1, 0.2, 0.3], [1. for _ in range(3)])]
